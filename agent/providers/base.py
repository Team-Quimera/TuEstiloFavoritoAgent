...
"""
Define la interfaz comun que todos los proveedores de WhatsApp
deben implementar. Esto permite cambiar de proveedor sin modificar
el resto del codigo del agente.
"""
